    ...
    <div class="">
        <div class="pageHeader">
            <div class="pageBread">
                ...
                <BreadcrumbItem>反馈管理</BreadcrumbItem>
...
export default {
    ...
    methods: {
        getInfo () {
            ...
            this.formItem.uid=this.$store.state.feedback.uid
            if (this.$route.query.sel){
                this.formItem.selection=JSON.parse(this.$store.state.feedback.selection)
                this.formItem.selectionKey=this.$store.state.feedback.selectionKey
            }
        },
        updata(e){
            let _this = this
            let datas={
                uid:this.$store.state.feedback.uid,
            ...
            this.$api.post("/admin/api/feedback/subject/update", datas, reset => {
                if (reset.code === 200) {
                    ...
                    _this.$router.push({path:"/feedback/list"});
                }else {
